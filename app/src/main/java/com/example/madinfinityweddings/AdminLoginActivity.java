        ...
        dbRef.child("admin1").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(admin[0].password.equals(password)){
                    ...
                    SharedPreferences.Editor editor=getSharedPreferences("adminDahboardPref",MODE_PRIVATE).edit();
                    editor.putString("adminFname", admin[0].getFname());
                    editor.putString("adminLname", admin[0].getLname());
                    editor.putString("adminEmail", admin[0].getEmail());
                    editor.putString("adminPassword", admin[0].getPassword());
                    editor.apply();
